...
export const ResturantCard = ({ name, cuisine, rating, time, imgSrc, offer, tag ,price, promoted}) => {
  return (
...
export const withPromotedResturant = (ResturantCard) => {
  ...
  return ({ name, cuisine, rating, time, imgSrc, offer, tag ,price,promoted})=>{
    ...
    return (
      ...
      <div className='res-card-img-wrap'>
        ...
        {/* Top-left tag e.g. "Bestseller" */}
        {promoted && (
          <span className='res-card-tag green'>{"promoted"}</span>
        )}
